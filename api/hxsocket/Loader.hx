package hxsocket;
    ...
    import neko.Lib;
#else
    #error "The hxsocket library is only supported on C++ and Neko targets."
#end
import hxstd.Error;
...
class Loader
{
     ...
     * @var String
     */
    private static inline var library:String = "libhxsocket";
     ...
     * @return Dynamic
     *
     * @throws hxstd.Error if trying to load the function throws an error
     */
    public static function load(fn:String, nargs:Int):Dynamic
    {
        try {
            #if HXSOCKET_LOADLAZY
